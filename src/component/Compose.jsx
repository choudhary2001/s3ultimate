...
const Compose = ({ display, updateall }) => {
  ...
  const [rotateCheckbox, setRotateCheckbox] = useState(false);
  const [editorvalue, setEditorValue] = useState("");
  const [subject, setSubject] = useState("");
  const [selectCategory, setSelectCategory] = useState(false);
  const [selected, setSelceted] = useState([]);
  const [showRotateCheckbox, setShowRotateCheckbox] = useState(false);
    ...
    <>
      <div className="main w-screen h-screen flex justify-center items-center fixed bg-[#80808072] z-10  backdrop-blur-[1px] flex-col">
        <div className=" w-[800px] h-[auto] rounded bg-white overflow-hidden">
          ...
          <div className="maineditor bg-white border-2 border-red-700 h-[550px]" style={{ background: "white !important", borderColor: "white" }}>
            <div>
            ...
            <div className="maineditor bg-white border-2 border-red-700" style={{ height: "78%", borderColor: "white" }} >
              {mode == 'design' ? (
                <ReactQuill
          ...
          <div className="bottombar w-full bg-red-900 p-1 relative" style={{ background: "white" }}>
